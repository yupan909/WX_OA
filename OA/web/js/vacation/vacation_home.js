...
function showList2(flag,curr){
	$.ajax({
		type:'post',
		url: "/vacation/editList.do?curr="+(curr || 1),
		data:{flag:flag},
		dataType:"json",
		success:function(data){
			if(""!=data && null!=data && typeof(data)!="undefined"){
				...
				if("db"==flag){ //待处理
					for(var i=0; i<list.length; i++){
						...
						html += '	<div class="col-xs-1 col-left"><span class="glyphicon glyphicon-calendar"></span></div>';
